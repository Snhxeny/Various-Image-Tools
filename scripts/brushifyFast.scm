(;    
;;  Paul Cooney 2021
;;  Applies a painterly effect
;;  Designed to run more quickly but may not look as good
 )

(define (script-fu-brushify 
	img
	drawable)
    ...
    ;(gimp-drawable-curves-spline cclayer 0 8 (
    ;    list->vector '(0.0 0.0 0.26953125 0.21875 0.7109375 0.82421875 1.0 1.0)));2
    (gimp-displays-flush)
...
(script-fu-register
  "script-fu-brushify"
  "<Image>/Filters/Brushify-Fast"
  "brushstrokes the image"
  "Paul"
  "Paul"
  "May 2021"
  "RGB*"
